...
Gem::Specification.new do |gem|
  gem.name          = "fluent-plugin-mystack_output"
  gem.version       = "0.1.0"
  gem.authors       = ["tfgco"]
  gem.email         = ["backend@tfgco.com"]
  gem.description   = %q{Fluentd output plugin for mystack}
  gem.summary       = %q{Fluentd output plugin for mystack}
  gem.homepage      = "https://github.com/topfreegames/mystack-logger"
  gem.license       = "ASL2"
